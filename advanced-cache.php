...
if ( ! @file_exists( '/Applications/MAMP/htdocs/dream/wp-content/plugins/breeze/breeze.php' ) ) { return; }
$config['config_path'] = '/Applications/MAMP/htdocs/dream/wp-content/breeze-config/breeze-config.php';
...
if ( @file_exists( '/Applications/MAMP/htdocs/dream/wp-content/plugins/breeze/inc/cache/execute-cache.php' ) ) {
	include_once '/Applications/MAMP/htdocs/dream/wp-content/plugins/breeze/inc/cache/execute-cache.php';
}
