...
if($logoFooter){
echo wp_get_attachment_image($logoFooter['id'],'full',"",['class'=>'w-100 h-auto','style'=>'max-width:75%;']); 
} elseif($logo) {
echo wp_get_attachment_image($logo['id'],'full',"",['class'=>'w-100 h-auto','style'=>'max-width:75%;']);
}
...
echo '<section class="pt-5 pb-5" style="background:#ebebeb;">';
echo '<div class="container">';
echo '<div class="row justify-content-center">';
